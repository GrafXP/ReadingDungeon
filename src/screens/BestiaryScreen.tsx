...
export function BestiaryScreen() {
  ...
  return <main id="main-content" className="screen collection-screen">
    <header className="screen-heading">
      ...
      <span className="count-badge">{game.studiedEnemyIds.length}/{total} beobachtet</span>
    </header>
    ...
    {enemies.length === 0 ? <section className="empty-state"><h2>Noch kein Eintrag</h2><p>Die erste Begegnung legt automatisch einen Eintrag an.</p></section> : <div className="bestiary-grid">
      {enemies.map((enemy) => {
