...
const puzzleInteractions: InteractionDefinition[] = [
  ...
  puzzleInteraction('int_sk_schleuse_abschliessen', 'sk_schleusensteg', 'Öffne den Wasserweg', 'Klares Wasser läuft durch die drei Tore. Der Weg zur Quellinsel ist frei.', [setFlag('schleuse_geloest')]),
  ...
  puzzleInteraction('int_vp_wegkreuz_abschliessen', 'vp_wegkreuz', 'Lege Alvas hellen Weg', 'Blatt, Welle und Flügel sind verbunden. Kunos Schatten hat daneben einen kleinen Pfeil gezeichnet.', [setFlag('wegkreuz_geloest')]),
  ...
  puzzleInteraction('int_lm_lichtweg_abschliessen', 'lm_nebelsteg', 'Lege den Lichtweg', 'Ring, Kerbe, Doppelstrich. Ein heller Weg reicht bis zur Lichtinsel.', [setFlag('lichtweg_gelegt')]),
  puzzleInteraction(
...
export const talora2Interactions: InteractionDefinition[] = [
  ...
  {
    id: 'int_sm_alvas_klinge_zeigen', areaId: 'sm_morgen_tempel', actionType: 'COMPLETE_INTERACTION', label: 'Sieh nach der Morgenklinge',
    description: 'Tessa erklärt, warum die alte Klinge im Bannschloss bleibt.',
    resultText: 'Die Morgenklinge bleibt bei Raugrims Schloss. «Diesmal retten wir keine Weltwaffe», sagt Tessa. «Wir holen Freunde nach Hause.»',
  ...
  },
  {
    ...
    description: 'Du brauchst Astholz und ein Rankenseil.', resultText: 'Lio bindet die breite Klinge fest. «Kapphieb stoppt eine Aufladung. Warte auf das Wort Aufladen.»',
...

  {
    ...
    requirement: flag('windruf_geloest'), effects: [addItem('item_mat_spulendraht')], restockAfterRest: true
  },
  {
  ...
  },
  {
    ...
    requirement: item('item_tool_nimas_zange'), effects: [addItem('item_mat_glutschale')], restockAfterRest: true
  },
  {
  ...
  },
  {
    ...
    description: 'Leite klares Wasser zum Ofenring.', resultText: 'Wasser läuft über den heissen Stein. Die Glutwalze zischt und wird langsamer.',
  ...
  },
  {
    ...
    description: 'Die verlassenen Wärmenetze geben weiche Felle frei.', resultText: 'Du nimmst zwei Felle. Nach einer Rast hängen wieder trockene Felle bereit.',
  ...
  },
  {
    ...
    description: 'Die Perle liegt im trockenen Teil der Grotte.', resultText: 'Die Perle ist kalt, aber sie brennt nicht. Nach einer Rast liegt eine neue am Rand.',
  ...
  {
    id: 'int_lm_blenden', areaId: 'lm_laternenhaus', actionType: 'COMPLETE_INTERACTION', label: 'Ordne Lumas drei Blenden',
    description: 'Stelle die kleine Blende vor die grosse und beide vor das Licht.', resultText: 'Der Lichtweg trifft den Blendengang, ohne Pavo zu blenden.',
  ...
  },
  {
    ...
    description: 'Luma braucht eine Moorfaser und einen Laternenstein.', resultText: 'Der Laternenstab wirft ein weiches Netz. Es zeigt Verstecktes und hält Flügel am Boden.',
    ...
    effects: [removeItem('item_mat_laternenstein'), addItem('item_weapon_laternenstab')]
  },
  {
